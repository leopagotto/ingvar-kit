...
class WebPluginGenerator {
  ...
  static _generatePackageJson(pluginName, pluginDir) {
    const packageJson = {
      ...
      version: '1.0.0',
      description: `Automated web dashboard plugin for Ingvar Kit`,
      type: 'module',
      main: 'dist/index.js',
      exports: {
        '.': {
...
export class ${this._toCamelCase(pluginName)}WebPlugin extends PluginInterface {
  ...
  getMetadata() {
    return {
      ...
      author: 'Generated by Ingvar Kit',
...
<body>
  <div id="app">
    <div class="container">
      <header class="header">
        <h1>🎯 INGVAR Workflow Dashboard</h1>
        <div class="status">
...
Automated web plugin for Ingvar Kit Dashboard.
