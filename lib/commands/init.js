...
`;
  ...
  if (!isNonInteractive) {
    ...
    if (installComponents) {
      console.log(chalk.gray('\n💡 Running: ingvar components --mode essential\n'));
      ...
      try {
        ...
        console.log(chalk.cyan('   ingvar components --mode essential\n'));
      }
    } else {
      console.log(chalk.gray('\n💡 You can install components later with:'));
      console.log(chalk.cyan('   ingvar components --mode essential   ') + chalk.gray('# 23 essential components'));
      console.log(chalk.cyan('   ingvar components --mode all         ') + chalk.gray('# All 72 components'));
      console.log(chalk.cyan('   ingvar components --mode cherry-pick ') + chalk.gray('# Choose interactively\n'));
    }
  }
}
