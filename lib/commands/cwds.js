...
async function cwdsCommand(action = 'install', options = {}) {
  // DEPRECATED: This command is deprecated in favor of 'ingvar components'
  console.log(chalk.yellow('\n⚠️  The "ingvar cwds" command is deprecated.\n'));
  console.log(chalk.cyan('Use the unified component installer instead:\n'));
  console.log(chalk.white('  ingvar components --mode essential   ') + chalk.gray('# Install 23 essential components'));
  console.log(chalk.white('  ingvar components --mode all         ') + chalk.gray('# Install all 72 components'));
  console.log(chalk.white('  ingvar components --mode cherry-pick ') + chalk.gray('# Choose components interactively'));
