...
async function listModels() {
  ...
  console.log(chalk.gray('  ingvar model list --tier=premium'));
  console.log(chalk.gray('  ingvar model list --provider=openai'));
  console.log(chalk.gray('  ingvar model list --cost=low\n'));
}
...
async function enableModelSelection(configManager) {
  ...
  try {
    ...
    console.log(chalk.cyan('\n💡 Next steps:\n'));
    console.log(chalk.gray('  1. Configure budgets: ingvar model budget'));
    console.log(chalk.gray('  2. Set API keys: export OPENAI_API_KEY=...'));
    console.log(chalk.gray('  3. Check status: ingvar model status\n'));
  } catch (error) {
...
async function manageBudget(configManager, args) {
  if (args.length === 0) {
    ...
    console.log(chalk.gray('  ingvar model budget daily 10'));
    console.log(chalk.gray('  ingvar model budget monthly 100'));
    console.log(chalk.gray('  ingvar model budget perAgent 20\n'));
    return;
  }
...
function showHelp() {
  ...
  console.log(chalk.white('Usage: ingvar model <command> [options]\n'));
  ...
  console.log(chalk.gray('  ingvar model list'));
  console.log(chalk.gray('  ingvar model status'));
  console.log(chalk.gray('  ingvar model budget daily 10'));
  console.log(chalk.gray('  ingvar model test frontend complex\n'));
}
