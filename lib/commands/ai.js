...
async function listAIs() {
  ...
  if (enabled.length === 0) {
    ...
    console.log(chalk.gray(`  Run ${chalk.cyan('ingvar ai add <ai-name>')} to add one.\n`));
    return;
  }
...
async function addAI(aiName) {
  if (!aiName) {
    ...
    console.log(chalk.gray('\nExample: ' + chalk.cyan('ingvar ai add cursor\n')));
    return;
  }
...
async function removeAI(aiName) {
  if (!aiName) {
    console.log(chalk.red('\n✗ Please specify an AI assistant name\n'));
    console.log(chalk.gray('Example: ' + chalk.cyan('ingvar ai remove cursor\n')));
    return;
  }
...
async function aiCommand(subcommand, ...args) {
  switch (subcommand) {
    ...
    default:
      ...
      console.log(chalk.cyan('  ingvar ai list') + chalk.gray('              # List configured AIs'));
      console.log(chalk.cyan('  ingvar ai add <ai-name>') + chalk.gray('    # Add AI assistant'));
      console.log(chalk.cyan('  ingvar ai remove <ai-name>') + chalk.gray(' # Remove AI assistant'));
      console.log(chalk.cyan('  ingvar ai sync') + chalk.gray('              # Regenerate all AI files'));
      console.log(chalk.cyan('  ingvar ai diff <ai1> <ai2>') + chalk.gray(' # Compare two AIs'));
      console.log('');
      ...
      console.log(chalk.gray('  ingvar ai add cursor'));
      console.log(chalk.gray('  ingvar ai add cline'));
      console.log(chalk.gray('  ingvar ai list'));
      console.log(chalk.gray('  ingvar ai sync\n'));
  }
}
