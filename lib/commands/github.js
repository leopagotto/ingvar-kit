...
async function setupGitHubSettings(options) {
  ...
  try {
    ...
    console.log(chalk.gray('💡 Run'), chalk.cyan('ingvar github status'), chalk.gray('to verify changes\n'));
...
async function showGitHubStatus(options) {
  ...
  try {
    ...
    console.log(chalk.gray('💡 Run'), chalk.cyan('ingvar github setup'), chalk.gray('to configure recommended settings\n'));
...
function showHelp() {
  ...
  console.log('  ingvar github <subcommand> [options]\n');
  ...
  console.log(chalk.gray('  ingvar github status'));
  console.log(chalk.gray('  ingvar github setup'));
  console.log(chalk.gray('  ingvar github setup --yes\n'));
}
