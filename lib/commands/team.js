...
class TeamCommands {
  /**
   * Initialize new Ingvar Kit team
   */
  static async init(options = {}) {
    console.log(chalk.cyan.bold('\n🦁 Ingvar Kit Team Initialization\n'));
  ...
  static async add(options = {}) {
    try {
      ...
      if (!config) {
        console.error(chalk.red('❌ No Ingvar Kit configuration found. Run "leo team init" first.'));
        return;
      }
