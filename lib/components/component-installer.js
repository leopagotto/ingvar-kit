...
class ComponentInstaller {
  ...
  async installSkapaPackage() {
    ...
    try {
      ...
      execSync('npm install ingvar-skapa-components', {
        stdio: 'inherit',
      ...
      console.log(chalk.cyan('  import { Button, Card, InputField, Switch } from \'ingvar-skapa-components/ingka-direct\';\n'));

      console.log(chalk.white('Option 2: Simplified wrappers (Rapid prototyping)\n'));
      console.log(chalk.cyan('  import { Button, TextField, Toggle } from \'ingvar-skapa-components\';\n'));

      console.log(chalk.blue.bold('📚 Documentation:\n'));
      console.log(chalk.gray('  Package README: ') + chalk.cyan('node_modules/ingvar-skapa-components/README.md'));
      ...
      console.log(chalk.white('  2. Check component list at node_modules/ingvar-skapa-components/COMPONENT_STATUS.md'));
      ...
      console.log(chalk.cyan('   npm install ingvar-skapa-components\n'));
      throw error;
    }
  }
