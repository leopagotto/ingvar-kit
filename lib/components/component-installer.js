...
class ComponentInstaller {
  ...
  async install(options = {}) {
    try {
      ...
      if (installMethod === 'npm-package') {
        // Install the @ingvar-kit/skapa-components package
   ...
   * NEW in v6.6.0 - Offers @ingvar-kit/skapa-components package
   */
  async chooseInstallationMethod(options) {
    ...
    const { method } = await inquirer.prompt([{
      ...
      choices: [
        {
          name: '🎁 npm Package (Recommended) - Install @ingvar-kit/skapa-components',
          value: 'npm-package',
          short: 'npm package'
        },
  ...
  /**
   * Install @ingvar-kit/skapa-components npm package
   * NEW in v6.6.0
   */
  async installSkapaPackage() {
    console.log(chalk.blue.bold('\n📦 Installing @ingvar-kit/skapa-components\n'));

    try {
      // Step 1: Install the package
      console.log(chalk.cyan('📥 Installing package...'));
      execSync('npm install @ingvar-kit/skapa-components', {
        stdio: 'inherit',
      ...
      console.log(chalk.cyan('  import { Button, Card, InputField, Switch } from \'@ingvar-kit/skapa-components/ingka-direct\';\n'));

      console.log(chalk.white('Option 2: Simplified wrappers (Rapid prototyping)\n'));
      console.log(chalk.cyan('  import { Button, TextField, Toggle } from \'@ingvar-kit/skapa-components\';\n'));

      console.log(chalk.blue.bold('📚 Documentation:\n'));
      console.log(chalk.gray('  Package README: ') + chalk.cyan('node_modules/@ingvar-kit/skapa-components/README.md'));
      console.log(chalk.gray('  Component List: ') + chalk.cyan('https://github.com/leopagotto/ingvar-kit/tree/master/packages/skapa-components'));
      console.log(chalk.gray('  Examples: 5 comprehensive usage examples in package README\n'));

      console.log(chalk.blue.bold('🎯 Quick Start:\n'));
      console.log(chalk.white('  1. Import components using either strategy'));
      console.log(chalk.white('  2. Check component list at node_modules/@ingvar-kit/skapa-components/COMPONENT_STATUS.md'));
      console.log(chalk.white('  3. See usage examples in package README'));
      console.log(chalk.white('  4. 64 components ready to use with TypeScript support\n'));

      console.log(chalk.green.bold('🎉 Installation Complete!\n'));
      console.log(chalk.gray('Run your dev server and start using Skapa components.\n'));
