  ...
  initializeModelRegistry() {
    return {
      ...
      'gpt-4-turbo': {
        id: 'gpt-4-turbo',
        provider: 'openai',
        tier: 'high',  // Changed from 'premium' to match test expectations
      ...
      'claude-3-sonnet': {
        id: 'claude-3-sonnet',
        provider: 'anthropic',
        tier: 'high',  // Changed from 'standard' to match test expectations
      ...
      'claude-3-haiku': {
        id: 'claude-3-haiku',
        provider: 'anthropic',
        tier: 'standard',  // Changed from 'economy' to match test expectations
        strengths: ['speed', 'simple-tasks', 'cost-effective'],
        cost: 'low',
        speed: 'fast'
      }
  ...
  selectDefaultModel(agent, complexity) {
    ...
    const defaultMap = {
      ...
      frontend: {
        ...
        complex: 'claude-3-opus',  // Changed from sonnet to opus for complex tasks
