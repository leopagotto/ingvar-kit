...
${chalk.cyan('        ╦   ╔═╗╔═╗  ')}${chalk.blue('╦ ╦╔═╗╦═╗╦╔═')}${chalk.magenta('╔═╗╦  ╔═╗╦ ╦')}${chalk.red('   ╦╔═╦╔╦╗')}
${chalk.cyan('        ║   ║╣ ║ ║  ')}${chalk.blue('║║║║ ║╠╦╝╠╩╗')}${chalk.magenta('╠╣ ║  ║ ║║║║')}${chalk.red('   ╠╩╗║ ║')}
${chalk.cyan('        ╩═╝ ╚═╝╚═╝  ')}${chalk.blue('╚╩╝╚═╝╩╚═╩ ╩')}${chalk.magenta('╚  ╩═╝╚═╝╚╩╝')}${chalk.red('   ╩ ╩╩ ╩')}

${chalk.gray('        ═══════════════════════════════════════════')}
        ${chalk.white.bold('Complete GitHub Workflow Automation Toolkit')}
     ${chalk.gray('Spec-Driven Development • GitHub Integration • Made Easy')}
${chalk.gray('        ═══════════════════════════════════════════')}
`;
}
...
function getCompactBanner() {
  return `
${chalk.yellow('    🦁')}  ${chalk.cyan.bold('LEO')} ${chalk.magenta('WORKFLOW')} ${chalk.blue('KIT')}
...
${chalk.yellow('    ╔═══════════════════════════════════════════════════════════════╗')}
${chalk.yellow('    ║                                                               ║')}
${chalk.yellow('    ║             ')}${chalk.cyan('🦁  ')}${chalk.cyan.bold('LEO WORKFLOW KIT')}${chalk.cyan('  🦁')}${chalk.yellow('                    ║')}
${chalk.yellow('    ║                                                               ║')}
