...
function getCompactBanner() {
  return `
${chalk.yellow('    🐺')}  ${chalk.yellow.bold('INGVAR-KIT 5.0.0')}
...
${chalk.yellow('    ╔═══════════════════════════════════════════════════════════════╗')}
${chalk.yellow('    ║                                                               ║')}
${chalk.yellow('    ║                  ')}${chalk.yellow('🐺  ')}${chalk.yellow.bold('INGVAR-KIT 5.0.0')}${chalk.yellow('  🐺')}${chalk.yellow('                    ║')}
${chalk.yellow('    ║                                                               ║')}
...
${chalk.yellow('    ╚═══════════════════════════════════════════════════════════════╝')}
    ...
    ${chalk.green.bold('✨ Successfully installed Ingvar Kit v5.0.0! ✨')}
...
${chalk.yellow('    ═══════════════════════════════════════════════════════════════')}
    ...
    ${chalk.white('Documentation:')} ${chalk.blue.underline('https://github.com/leopagotto/ingvar-kit#readme')}
    ${chalk.white('Spec Guide:     ')} ${chalk.blue.underline('https://github.com/leopagotto/ingvar-kit/wiki/Spec-First-Decision-Making')}
    ${chalk.white('Report Issues:  ')} ${chalk.blue.underline('https://github.com/leopagotto/ingvar-kit/issues')}

${chalk.yellow('    ═══════════════════════════════════════════════════════════════')}

    ${chalk.green.bold('🎉 Ready to transform your workflow!')} ${chalk.gray('Start with')} ${chalk.yellow('ingvar init')}
