 ...
 * Handles loading and managing model selection configuration from .ingvarrc.json
 */
...
class ModelConfigManager {
  constructor(configPath = null) {
    this.configPath = configPath || path.join(process.cwd(), '.ingvarrc.json');
  ...
  getCurrentPhase() {
    ...
    const phase = process.env.INGVAR_PHASE || process.env.NODE_ENV || 'development';
    const modelConfig = this.getModelSelectionConfig();
