...
function generateOrchestratorInstructions(config = {}) {
  ...
  return `# Orchestrator Agent - Ingvar Workflow Kit
...
\`\`\`bash
ingvar agent add frontend  # Enable Frontend Agent
ingvar agent add backend   # Enable Backend Agent
ingvar agent add testing   # Enable Testing Agent
\`\`\`
`;
  }
  ...
  list += `\`\`\`bash\n`;
  list += `ingvar agent list           # See all available agents\n`;
  list += `ingvar agent add <name>    # Enable additional agent\n`;
  list += `\`\`\`\n`;
