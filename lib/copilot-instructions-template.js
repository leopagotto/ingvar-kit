// Enhanced Copilot Instructions Template for Ingvar Kit
...
Ingvar Kit provides **TWO COMPLEMENTARY component systems**:
...
- 🎯 Already installed with ingvar-kit
...
\`\`\`bash
ingvar components add Button  # Copies to src/components/
\`\`\`
...
Check: Does template exist in templates/ingka-components/Button/?
  ↓ YES
✅ ingvar components add Button (then modify)
  ↓ NO
...
- Disable: \`ingvar config set auto-resolve false\`
- Enable: \`ingvar config set auto-resolve true\`
- Check: \`ingvar config get auto-resolve\`
...
**🦁 Ingvar Kit - Spec-Driven Development Made Simple 🦁**
