...
> - ✅ Create GitHub issues IMMEDIATELY when user describes work (NO asking permission)
> - ✅ Check \`.leorc.json\` for \`auto-resolve\` setting BEFORE working
...
**🦁 LEO Workflow Kit - Spec-Driven Development Made Simple 🦁**
