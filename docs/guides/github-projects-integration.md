...
Ingvar Workflow Kit now automatically integrates with GitHub Projects, adding issues to your project board with proper status tracking. When Copilot creates an issue, it automatically:
