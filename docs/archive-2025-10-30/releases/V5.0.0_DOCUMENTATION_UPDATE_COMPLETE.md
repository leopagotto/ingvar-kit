...
- ✅ Aligns with Ingvar branding after rebranding from INGVAR
...
1. **Architecture Section**
   ...
   - Updated: "Ingvar v4.1.1" → "Ingvar v5.0.0"
...
3. **Automatic Installation Method**
   ...
   - Command: `npm install -g ingvar-kit@4.1.1` → `@5.0.0`
...
- ✅ Ingvar Kit logo displays correctly at top
...
**Installation:** `npm install -g ingvar-kit@5.0.0`
**Verify:** `ingvar --version` → 5.0.0
...
- Update their local installation: `npm install -g ingvar-kit@5.0.0`
- Run `ingvar init` to experience improved UI
